...
<table align= "center">
<th><input class="btn btn-success" type='button' style='cursor: pointer' onclick=abc10() value='Cash On Delivery' /></td><th><input class="btn btn-primary" type='button'style='cursor: pointer' onclick=abc11() value='BANK' /></td>
</table>
</form>
